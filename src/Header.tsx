...
const Header = () => {
  ...
  return (
    ...
    <header className="bg-boo-700 fixed  top-0 right-0 flex justify-end sm:w-fit w-full z-[9999]">
      <Link href="" onClick={() => changeNav("home", false)} className="text-white w-full flex justify-left items-center text-xl font-bold uppercase float-left leading-8 tracking-wider py-[12px] px-5">{siteMetadata.WebName}</Link>
