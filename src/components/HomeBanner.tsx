    ...
    >
      ...
      >
        ...
        <div className="flex md:flex-row flex-col !mx-0 h-full">
          <div className="md:pt-0 pt-2 p-0 overflow-hidden md:items-end items-start md:justify-end justify-end flex flex-col md:h-screen h-[450px] md:w-full w-full bg-boo-600">
              {" "}
              <Carousel
