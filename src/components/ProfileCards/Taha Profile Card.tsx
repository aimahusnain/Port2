...
const TPC = ({height}) => {
  ...
  return (
    <div className={`w-full flex items-center justify-center flex-col ${height} max-h-full !max-w-full rounded-xl text-trueGray-800 dark:text-trueGray-400 overflow-hidden group motion-safe:transition-all motion-safe:duration-700 m-0 p-0`}>
